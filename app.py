...
def _diff_fields(prev: dict, curr: dict):
    keys = ["title","agency","naics","psc","set_aside","posted_at","due_at","status","place_city","place_state","rfp_schema","rfp_parser","subfinder_paging","subfinder_filters","subfinder_sources","subfinder_outreach","rfqg_composer","rfqg_outreach","rfqg_intake"]
    changes = []
    for k in keys:
