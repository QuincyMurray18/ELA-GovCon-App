...
import pandas as pd
import streamlit as stimport numpy as npimport requestsfrom PyPDF2 import PdfReaderimport docxfrom sklearn.feature_extraction.text import TfidfVectorizer
...
with tabs[1]:
    ...
    if df_opp.empty:
        ...
        edit = st.data_editor(df_opp, use_container_width=True, num_rows="dynamic", key="opp_grid", column_config={"url": st.column_config.LinkColumn("Link", display_text="open")})
