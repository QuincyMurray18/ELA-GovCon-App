...
def render_outreach_tools():
    ...
    with st.container(border=True):
        st.markdown("#### ")
        extra_files = st.file_uploader("", type=None, accept_multiple_files=True,
    ...
    with st.container(border=True):
        ...
        if not mb:
            ...
            extra_files = st.file_uploader("", collapsed", label_visibility="collapsed")", type=None, accept_multiple_files=True,
...
def load_outreach_preview(to="", cc="", bcc="", subject="", html=""):
    ...
    with st.expander("Quick Outreach Composer", expanded=False):
        ...
        files = st.file_uploader("", type=None, accept_multiple_files=True, key=ns_key("outreach::mail_files", label_visibility="collapsed"))
...
with legacy_tabs[11]:
    ...
    if pick == "➤ New chat":
        ...
        if session_id is None:
            ...
            up_files = st.file_uploader("", collapsed", label_visibility="collapsed")", type=["pdf","docx","doc","txt"],
...
with st.sidebar:
    ...
    naics_csv = st.file_uploader("", collapsed", label_visibility="collapsed")", type=["csv"])
