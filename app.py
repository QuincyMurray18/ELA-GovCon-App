...
def render_outreach_tools():
    ...
    with st.container(border=True):
        st.markdown("#### ")
        extra_files = st.file_uploader("", type=None, accept_multiple_files=True, key=ns_key("outreach::extra_files", label_visibility="collapsed", label_visibility="collapsed"))
    ...
    with st.container(border=True):
        ...
        if not mb:
            ...
            extra_files = st.file_uploader("",  label_visibility="collapsed", label_visibility="collapsed")", type=None, accept_multiple_files=True,
...
def load_outreach_preview(to="", cc="", bcc="", subject="", html=""):
    ...
    with st.expander("Quick Outreach Composer", expanded=False):
        ...
        files = st.file_uploader("", type=None, accept_multiple_files=True, key=ns_key("outreach::mail_files", label_visibility="collapsed", label_visibility="collapsed"))
...
Certifications Small Business"""
    ...
    if cap_md:
        ...
        logo_file = st.file_uploader("", type=["png", "jpg", "jpeg"], key="cap_logo_upload", label_visibility="collapsed")
...
with legacy_tabs[7]:
    ...
    if wp_md:
        ...
        if issues:
            st.warning("Before export, fix these items: " + "; ".join(issues))
        wp_logo_file = st.file_uploader("", type=["png", "jpg", "jpeg"], key="wp_logo_upload", label_visibility="collapsed")
...
with legacy_tabs[9]:
    ...
    up = st.file_uploader("", type=["pdf", "docx", "doc", "txt"], accept_multiple_files=True, key="auto_up", label_visibility="collapsed")
...
with legacy_tabs[10]:
    ...
    up2 = st.file_uploader("", type=["pdf", "docx", "doc", "txt"], accept_multiple_files=True, key="qna_up", label_visibility="collapsed")
...
with legacy_tabs[11]:
    ...
    if pick == "➤ New chat":
        ...
        if session_id is None:
            ...
            up_files = st.file_uploader("",  label_visibility="collapsed", label_visibility="collapsed")", type=["pdf","docx","doc","txt"],
...
with legacy_tabs[__tabs_base + 1]:
    ...
    up = st.file_uploader("", type=["pdf", "docx", "doc", "txt"], accept_multiple_files=True, key="lm_up", label_visibility="collapsed")
...
with st.sidebar:
    ...
    naics_csv = st.file_uploader("",  label_visibility="collapsed", label_visibility="collapsed")", type=["csv"])
...
def render_rfp_analyzer():
    try:
        ...
        uploads = st.file_uploader("", type=["pdf", "docx", "doc", "txt"], accept_multiple_files=True, key=f"rfp_up_{session_id}", label_visibility="collapsed")
